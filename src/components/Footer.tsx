    ...
    <footer className="border-t">
      <div className="mx-auto container space-y-8 px-4 py-16 lg:space-y-16">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            ...
            <p className="mt-4 max-w-xs text-muted-foreground">
              We connect people and businesses with reliable, secure deliveries every day. Our mission is to ensure every package arrives safely and promptly, no matter the destination
            </p>
        ...
        <p className="text-xs text-muted-foreground">
          &copy; 2022. Parcel Devery system. All rights reserved.
        </p>
      </div>
    </footer>
  );
